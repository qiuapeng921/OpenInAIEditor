...
import com.github.qiuapeng921.openaieditor.utils.KiroLauncher

/**
 * 在 Kiro 中打开文件夹的动作类
 * 处理文件夹右键菜单中的 "Open in Kiro" 选项
 */
class OpenFolderInKiroAction : AnAction() {
    ...
    override fun actionPerformed(e: AnActionEvent) {
        ...
        virtualFile?.let { file ->
            if (file.isDirectory) {
                KiroLauncher.openInKiro(project, file.path)
            }
        }
    }
}